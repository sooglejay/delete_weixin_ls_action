<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="MxWeiXinPF.Web.weixin.LSAction.LSHaoYundzp.index" %>
				...
				<div class="g-left">
					...
					<div class="active-hdgz">
						...
						<p>
							1.话费流量奖励仅限凉山移动用户；
							<br />2.话费奖励将于奖励次月中旬到账；
							<br />3.流量奖励将流量卷形式下发，请下载“四川移动和生活”客户端，进入底部菜单“我的” - “卡卷”进行激活使用。流量卷仅限中奖当月激活，激活流量当月省内使用有效；
							<br />4.摄影抵扣卷为：西昌巴卜儿童亲子摄影现金抵扣卷，单张价值500
						</p>
		            </div>
					<div class="five-ten-footer">
						<img class="fl" src="img/lottery/feet-01.png"/>
						<img class="fr" src="img/lottery/feet-02.png"/>
						<a href="http://a.app.qq.com/o/simple.jsp?pkgname=com.sichuan.iwant"><img class="ftf-btn-img" src="img/lottery/download.png"/></a>
						<div class="clear"></div>
					</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-zp">
					<div class="modal-header" style="border: none">
						<button style="color: white;opacity: 1" type="button" class="close" data-dismiss="modal" aria-label="Close"><span
		...
		<script>
		    ...
		    $(function () {
		        ...
		        var clickfunc = function () {
		            ...
		            switch (data) {
		                case 1:
		                    rotateFunc(1, 0, '恭喜您获得5元话费');
		                    break;
		                case 2:
		                    rotateFunc(2, 60, '恭喜您获得10元话费');
		                    break;
		                case 3:
		                    rotateFunc(3, 120, '恭喜您获得100M流量卷,请下载“四川移动和生活”客户端激活');
		                    break;
		                case 4:
		                    rotateFunc(4, 180, '恭喜您获得200M流量卷,请下载“四川移动和生活”客户端激活');
		                    break;
		                case 5:
		                    rotateFunc(5, 240, '恭喜您获得500摄影抵用券');
		                    break;
		                case 6:
		                    rotateFunc(6, 300, '谢谢惠顾 下次继续');
		                    break;
		            }
		        };
		        $btn.click(function () {
		        ...
		        $('.btn-sub').on('click', function () {
		            ...
		            if (inputYZ.val() != "") {
		                ...
		                $.post('/weixin/ucard/ucardprocess.ashx?myact=dzpuser', submitData,
                             function (data) {
                                 debugger;
                                 if (data.ret == "succ") {
