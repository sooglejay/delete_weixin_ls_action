<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="game.aspx.cs" Inherits="MxWeiXinPF.Web.weixin.LSAction.LSYueLiang.game" %>
...
<body>
    ...
    <div class="game vr">
        <header>
			...
			<div class="game-header-number">积累票数&nbsp;&nbsp;<span><%=Totalcount %></span></div>
		</header>
        </header>
        <main>
			<div class="tpgz">
            ...
            <% foreach (var item in ylist)
               {%>
				<div class="list-goods box girl fl">
					<a href="detail.aspx?yid=<%=item.yid %>&wid=<%=wid %>&sid=<%=sid %>&openid=<%=openid %>"><img class="img-100" src="http://juzhen.sdtzcd.com/<%=item.Img %>" /></a>
